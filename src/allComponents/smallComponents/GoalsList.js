        ...
        </tr>
        {
            goals.map((goal,index)=>{
                return (
                    ...
                    <td><a className="btn main-color-bg" onClick={this.paidHandler}>Paid</a><a className="btn btn-default" href="#/editgoal/1">Edit</a> <a className="btn btn-danger" onClick={()=>this.deleteGoalHandler(1)}>Delete</a></td>
                    </tr>
                )
            })
        }
