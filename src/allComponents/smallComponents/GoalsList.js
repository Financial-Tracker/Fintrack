                                        ...
                                        goals.map((goal, index) => {
                                            return (
                                                <tr key={index}>
                                                    ...
                                                    <td><a className="btn main-color-bg" onClick={this.paidHandler}>Paid</a><a className="btn btn-default" href={`#/editgoal/${index}`} onClick={this.editHandler}>Edit</a> <a className="btn btn-danger" onClick={() => this.deleteGoalHandler(index)}>Delete</a></td>
                                                </tr>
                                            )
                                        })
                                    }
