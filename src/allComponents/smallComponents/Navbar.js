            ...
            <div id="navbar" className="collapse navbar-collapse">
              <ul className="nav navbar-nav">
                ...
                {this.props.link === "Ways to save" ? (
                  <li className="active">
                    <a href="#/waystosave">Ways to save</a>
                  </li>
                ) : (
                  <li>
                    <a href="#/waystosave">Ways to save</a>
              ...
              <ul className="nav navbar-nav navbar-right">
                {this.props.link === "Settings" ? (
                  <li className="active">
                    <a href="#/settings">Welcome, Francisco</a>
                  </li>
                ) : (
                  <li>
                    <a href="#/settings">Welcome, Francisco</a>
              ...
              <div className="col-md-10">
                <h1>
                  <span
                    ...
                    aria-hidden="true"
                  />{" "}
                  FinTrack <small>All About The Green</small>
                </h1>
              </div>
              <div className="col-md-2">
                <div className="dropdown create">
                  ...
                  <ul className="dropdown-menu" aria-labelledby="dropdownMenu1">
                    <li>
                      <a href="#/plaid">Change Bank Account</a>
                    </li>
                    <li>
                      <a
                        type="button"
                        data-toggle="modal"
                        data-target="#addGoalForm"
                      >
                        Add Goal
                      </a>
                    </li>
